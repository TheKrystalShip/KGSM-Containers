...
export instance_executable_file="/usr/lib/wine/wine64"
export instance_executable_arguments="$instance_launch_dir/EmpyrionDedicated.exe -batchmode -nographics -dedicated $instance_saves_dir/dedicated.yaml -logFile $instance_logs_redirect"
...
function _start() {
  ...
  if [[ ! -f "$instance_version_file" ]] || [[ ! -d "$instance_install_dir" ]] || [[ ! -f "$instance_launch_dir/EmpyrionDedicated.exe" ]]; then
