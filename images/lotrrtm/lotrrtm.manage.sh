...
# KGSM-Container management file for lotrrtm
#
...
export instance_launch_dir="$instance_install_dir/Moria/Binaries/Win64"

export instance_steam_app_id=3349480
export instance_is_steam_account_required=0

export instance_platform="windows"
export instance_executable_file="$instance_launch_dir/MoriaServer-Win64-Shipping.exe"
export instance_executable_arguments="Moria"
...
export instance_stop_command="exit"
