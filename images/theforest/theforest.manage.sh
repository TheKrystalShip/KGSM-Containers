...
export instance_steam_app_id=556450
export instance_is_steam_account_required=0

export instance_platform="windows"
export instance_executable_file="$instance_launch_dir/TheForestDedicatedServer.exe"
export instance_executable_arguments="-batchmode -dedicated -savefolderpath $instance_saves_dir -configfilepath $instance_saves_dir/server.cfg"
