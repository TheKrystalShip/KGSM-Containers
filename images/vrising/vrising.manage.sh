...
export instance_executable_arguments="$instance_install_dir/VRisingServer.exe -persistentDataPath $instance_saves_dir"
...
trap '[[ "${instance_enable_port_forwarding:-0}" == "true" ]] && _disable_upnp' INT TERM
