...
# KGSM-Container management file for Abiotic Factor (abioticfactor)
#
...
export instance_launch_dir="$instance_install_dir/AbioticFactor/Binaries/Win64"

export instance_steam_app_id=2857200
...
export instance_executable_file="$instance_launch_dir/AbioticFactorServer-Win64-Shipping.exe"
export instance_executable_arguments="-tcp -useperfthreads -MaxServerPlayers=$max_server_players -PORT=$port -QueryPort=$query_port -ServerPassword=$server_password -SteamServerName=$steam_server_name -WorldSaveName=$world_save_name $additional_args"
